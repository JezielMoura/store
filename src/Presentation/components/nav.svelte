...
<style>
    nav { 
        width: 240px; height: 100%; top: 0; left: 0; background: rgb(2, 89, 129); position: fixed;}

        nav h1 { 
            display: block; color: #fff; text-align: center; padding: 20px; box-shadow: 0 2px 3px rgba(0,0,0,0.1);
            margin-bottom: 20px;}
</style>